...
const steps = [
  ...
  ["Phase 41A ChatGPT native writing output adoption settlement boundary final smoke", ["tests/phase41/phase41b-explicit-candidate-workflow-intake-boundary-smoke.test.mjs"]],

  ["Phase 41A ChatGPT native writing output adoption settlement boundary final smoke", ["tests/phase41/phase41c-explicit-candidate-write-preview-boundary-smoke.test.mjs"]],

  ["Phase 41A ChatGPT native writing output adoption settlement boundary final smoke", ["tests/phase41/phase41d-explicit-candidate-persist-boundary-smoke.test.mjs"]],

  ["Phase 41A ChatGPT native writing output adoption settlement boundary final smoke", ["tests/phase41/phase41e-explicit-candidate-runtime-write-gate-smoke.test.mjs"]],

  ["Phase 41A ChatGPT native writing output adoption settlement boundary final smoke", ["tests/phase41/phase41f-explicit-candidate-runtime-write-implementation-readiness-smoke.test.mjs"]],
  ...
  ["Phase 42B production candidate store promotion gate audit rollback readiness smoke", ["tests/phase42/phase42b-production-candidate-store-promotion-gate-audit-rollback-readiness-smoke.test.mjs"]],

  ["Phase 42C production candidate store promotion gate preflight contract smoke", ["tests/phase42/phase42c-production-candidate-store-promotion-gate-preflight-contract-smoke.test.mjs"]],
...
["Phase 42F production candidate store promotion gate guard token pre-consumption boundary smoke", ["tests/phase42/phase42f-production-candidate-store-promotion-gate-guard-token-pre-consumption-boundary-smoke.test.mjs"]],
  ...
  ["Phase 42H production candidate store promotion gate approval request preflight boundary smoke", ["tests/phase42/phase42h-production-candidate-store-promotion-gate-approval-request-preflight-boundary-smoke.test.mjs"]],

  ["Phase 42I production candidate store promotion gate approval request creation denial smoke", ["tests/phase42/phase42i-production-candidate-store-promotion-gate-approval-request-creation-denial-smoke.test.mjs"]],

  ["Phase 42J production candidate store promotion gate pending engine candidate preflight boundary smoke", ["tests/phase42/phase42j-production-candidate-store-promotion-gate-pending-engine-candidate-preflight-boundary-smoke.test.mjs"]],

  ["Phase 42K production candidate store promotion gate pending engine candidate creation denial smoke", ["tests/phase42/phase42k-production-candidate-store-promotion-gate-pending-engine-candidate-creation-denial-smoke.test.mjs"]],

  ["Phase 42L production candidate store promotion gate production write preflight boundary smoke", ["tests/phase42/phase42l-production-candidate-store-promotion-gate-production-write-preflight-boundary-smoke.test.mjs"]],

  ["Phase 42M production candidate store promotion gate production write execution denial smoke", ["tests/phase42/phase42m-production-candidate-store-promotion-gate-production-write-execution-denial-smoke.test.mjs"]],

  ["Phase 42N production candidate store promotion gate production promotion preflight boundary smoke", ["tests/phase42/phase42n-production-candidate-store-promotion-gate-production-promotion-preflight-boundary-smoke.test.mjs"]],

  ["Phase 42O production candidate store promotion gate production promotion execution denial smoke", ["tests/phase42/phase42o-production-candidate-store-promotion-gate-production-promotion-execution-denial-smoke.test.mjs"]],
  ...
  ["Maintenance formal phase inventory completeness", ["tests/maintenance/run-all-formal-phase-inventory-completeness.test.mjs"]],
  ...
  ["Phase 62A-R1 formal MCP public adoption", ["tests/phase62/phase62a-r1-formal-mcp-public-adoption.test.mjs"]],
  ["Phase 62A-R1 global boundary closure", ["tests/phase62/phase62a-r1-global-boundary-closure.test.mjs"]],
  ["Phase 62A-R1 prepared-turn transport core", ["tests/phase62/phase62a-r1-prepared-turn-transport-core.test.mjs"]],
  ["Phase 62A-R2 capability role normalization", ["tests/phase62/phase62a-r2-capability-role-normalization.test.mjs"]],
  ["Phase 62A-R2 neural evidence contract truth", ["tests/phase62/phase62a-r2-neural-evidence-contract-truth.test.mjs"]],
  ...
  ["Phase 62F continuous projectile and ability physics", ["tests/phase62/phase62f-continuous-projectile-ability-physics.test.mjs"]],
  ["Phase 62G unified global causal timeline", ["tests/phase62/phase62g-unified-global-causal-timeline.test.mjs"]],
  ["Phase 62H dynamic timeline refinement", ["tests/phase62/phase62h-dynamic-timeline-refinement.test.mjs"]],
  ["Phase 62I continuous actor-state scheduler", ["tests/phase62/phase62i-continuous-actor-state-scheduler.test.mjs"]],
  ["Phase 62J unified chronological mutation queue", ["tests/phase62/phase62j-unified-chronological-mutation-queue.test.mjs"]],
  ["Phase 62K authoritative mutation executor", ["tests/phase62/phase62k-authoritative-mutation-executor.test.mjs"]],
  ["Phase 62L proposal-only subsystem boundary", ["tests/phase62/phase62l-proposal-only-subsystem-boundary.test.mjs"]],
  ["Phase 62M pure proposal producer interface", ["tests/phase62/phase62m-pure-proposal-producer-interface.test.mjs"]],
  ["Phase 62N immutable causal effect evaluators", ["tests/phase62/phase62n-immutable-causal-effect-evaluators.test.mjs"]],
  ["Phase 62O immutable physics effect evaluators", ["tests/phase62/phase62o-immutable-physics-effect-evaluators.test.mjs"]],
  ["Phase 62P immutable projectile lifecycle", ["tests/phase62/phase62p-immutable-projectile-lifecycle.test.mjs"]],
  ["Phase 62Q immutable ability-field lifecycle", ["tests/phase62/phase62q-immutable-ability-field-lifecycle.test.mjs"]],
  ["Phase 62R immutable event discovery queries", ["tests/phase62/phase62r-immutable-event-discovery-queries.test.mjs"]],
  ["Phase 62S immutable event arbitration", ["tests/phase62/phase62s-immutable-event-arbitration.test.mjs"]],
  ["Phase 62T cross-layer event arbitration", ["tests/phase62/phase62t-cross-layer-event-arbitration.test.mjs"]],
  ["Phase 62U causal epoch freshness", ["tests/phase62/phase62u-causal-epoch-freshness.test.mjs"]],
  ["Phase 62V fixed-point convergence", ["tests/phase62/phase62v-fixed-point-convergence.test.mjs"]],
  ["Phase 62W programmatic visibility occlusion", ["tests/phase62/phase62w-programmatic-visibility-occlusion.test.mjs"]],
  ["Phase 62X directional-height visibility", ["tests/phase62/phase62x-directional-height-visibility.test.mjs"]],
  ["Phase 62Y illumination visibility", ["tests/phase62/phase62y-illumination-visibility.test.mjs"]],
  ["Phase 62Z audibility propagation", ["tests/phase62/phase62z-audibility-propagation.test.mjs"]],
  ["Phase 63A subjective memory formation", ["tests/phase63/phase63a-subjective-memory-formation.test.mjs"]],
  ["Phase 63B memory accessibility retrieval", ["tests/phase63/phase63b-memory-accessibility-retrieval.test.mjs"]],
  ...
  ["Phase 76B post-outcome subjective memory bridge", ["tests/phase76/phase76b-post-outcome-subjective-memory-bridge.test.mjs"]],
  ...
  ["Phase 81A post-outcome counterfactual alternative evidence", ["tests/phase81/phase81a-post-outcome-counterfactual-alternative-evidence.test.mjs"]],
  ...
  ["Phase 81I retained counterfactual-linked experience cross-turn re-entry", ["tests/phase81/phase81i-counterfactual-linked-experience-reentry.test.mjs"]],
  ["Phase 81J retained counterfactual-linked experience reuse deliberation", ["tests/phase81/phase81j-counterfactual-linked-experience-reuse-deliberation.test.mjs"]],
  ["Phase 81K counterfactual-linked reuse intent selected-action lineage", ["tests/phase81/phase81k-counterfactual-linked-experience-selected-action-lineage.test.mjs"]],
  ["Phase 81L reused counterfactual-linked selected-action subjective outcome evidence", ["tests/phase81/phase81l-counterfactual-linked-experience-reuse-outcome-evidence.test.mjs"]],
  ...
  ["Phase 82C bounded longitudinal reuse-outcome qualitative appraisal", ["tests/phase82/phase82c-counterfactual-linked-experience-longitudinal-reuse-outcome-appraisal.test.mjs"]],
  ...
  ["CB-C4 person-targeted social appraisal", ["tests/communication/cb-c4-person-targeted-social-appraisal.test.mjs"]],
  ["CB-C4 Native person-targeted social appraisal", ["tests/communication/cb-c4-native-person-targeted-social-appraisal.test.mjs"]],
  ["CB-C4 social appraisal experience bridge", ["tests/communication/cb-c4-social-appraisal-memory-bridge.test.mjs"]],
  ["CB-C4 Native subjective social memory admission", ["tests/communication/cb-c4-native-social-memory-admission.test.mjs"]],
  ["CB-C4 committed social relationship evidence", ["tests/communication/cb-c4-social-relationship-evidence.test.mjs"]],
  ["CB-C4 Native divergent social readback", ["tests/communication/cb-c4-native-divergent-social-readback.test.mjs"]],
