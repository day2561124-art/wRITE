...
export const chatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceKind =
  "chatgpt_bridge_operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance";

export const chatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceVersion =
  "chatgpt_bridge_operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance_v1";

export const chatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceRequiredField =
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceRequiredTopLevelKeys() {
  return [
    "tool_name",
    "permission",
    "chatgpt_final_output",
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceForbiddenSources() {
  return [
    "tool_response.result.*",
    "tool_response.result.final_candidate_text",
    "tool_response.result.extracted_chatgpt_final_output.output_text",
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceItems() {
  return [
    {
      id: "must_read_phase37b_operator_extraction_message_text",
      status: "required",
      instruction:
        "Read the final operator message only from Phase37B real_chatgpt_live_mcp_operator_extraction_message_text.",
      required_read_field:
        chatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceRequiredField,
      required_value: true,
    },
    {
      id: "must_not_read_result_or_chatgpt_final_output",
      status: "required",
      instruction:
        "Do not read result.*, chatgpt_final_output.output_text, or nested candidate text.",
      required_value: true,
    },
    {
      id: "must_not_directly_read_phase36l_36m_or_37a",
      status: "required",
      instruction:
        "Do not directly read Phase36L, Phase36M, or Phase37A message fields from the final consumer path.",
    ...
    {
      id: "must_ignore_output_text_and_operator_display_decoys",
      status: "required",
      instruction:
        "Ignore output_text/operator_display_text decoys on 36L, 36M, 37A, and 37B diagnostics surfaces.",
      required_value: true,
    },
    {
      id: "must_preserve_final_consumer_contract_reference_only",
      status: "required",
      instruction:
        "The final operator message consumer contract is reference-only and must not become a story/candidate output layer.",
      required_value: true,
    },
  ];
}

export function acceptChatgptOperatorCompactDiagnosticsFromRealChatgptFinalOperatorMessageConsumerContractAcceptance(toolResponse = {}) {
  return toolResponse
    ?.chatgpt_operator_compact_diagnostics_real_chatgpt_live_mcp_final_emission_operator_extraction_consumer_hard_seal
    ?.real_chatgpt_live_mcp_operator_extraction_message_text;
}

export function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptance(toolResponse = {}) {
  const phase37B =
    toolResponse
      ?.chatgpt_operator_compact_diagnostics_real_chatgpt_live_mcp_final_emission_operator_extraction_consumer_hard_seal
    ?? null;
  ...
  const phase37BIndex =
    topLevelKeys.indexOf("chatgpt_operator_compact_diagnostics_real_chatgpt_live_mcp_final_emission_operator_extraction_consumer_hard_seal");
  const phase37CIndex =
    topLevelKeys.indexOf("chatgpt_operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance");
  const requiredTopLevelKeys =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceRequiredTopLevelKeys();
  const forbiddenSources =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceForbiddenSources();
  const acceptanceItems =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceItems();
  const acceptedText =
    acceptChatgptOperatorCompactDiagnosticsFromRealChatgptFinalOperatorMessageConsumerContractAcceptance(toolResponse);
  const validationErrors = [];
  ...
  if (phase37BIndex < 0) {
    validationErrors.push("top_level_phase37b_operator_extraction_consumer_hard_seal_missing");
  }

  if (phase37BIndex >= 0 && phase37CIndex >= 0 && phase37BIndex > phase37CIndex) {
    validationErrors.push("phase37b_operator_extraction_consumer_hard_seal_should_precede_phase37c_final_consumer_acceptance");
  }

  if (resultIndex >= 0 && phase37CIndex >= 0 && phase37CIndex > resultIndex) {
    validationErrors.push("phase37c_final_consumer_acceptance_should_precede_result");
  }

  if (phase37B?.used !== true) {
    validationErrors.push("phase37b_operator_extraction_consumer_hard_seal_used_false_or_missing");
  }

  if (phase37B?.phase !== "37B") {
    validationErrors.push("phase37b_operator_extraction_consumer_hard_seal_phase_not_37b");
  }

  if (phase37B?.contract_valid !== true) {
    validationErrors.push("phase37b_operator_extraction_consumer_hard_seal_invalid");
  }

  if (
    phase37B?.real_chatgpt_live_mcp_operator_extraction_required_read_field
    !== "tool_response.chatgpt_operator_compact_diagnostics_live_mcp_final_emission_contract_smoke.live_mcp_final_emission_contract_message_text"
  ) {
    validationErrors.push("phase37b_operator_extraction_required_read_field_mismatch");
  }

  if (phase37B?.real_chatgpt_live_mcp_operator_extraction_must_read_exact_field !== true) {
    validationErrors.push("phase37b_operator_extraction_exact_field_guard_not_true");
  }

  if (typeof phase37B?.real_chatgpt_live_mcp_operator_extraction_message_text !== "string") {
    validationErrors.push("phase37b_operator_extraction_message_text_missing_or_not_string");
  }

  if (
    typeof phase37B?.real_chatgpt_live_mcp_operator_extraction_message_hash !== "string"
    || phase37B.real_chatgpt_live_mcp_operator_extraction_message_hash.length === 0
  ) {
    validationErrors.push("phase37b_operator_extraction_message_hash_missing");
  } else if (
    typeof phase37B?.real_chatgpt_live_mcp_operator_extraction_message_text === "string"
    && phase37B.real_chatgpt_live_mcp_operator_extraction_message_hash
      !== sha256(phase37B.real_chatgpt_live_mcp_operator_extraction_message_text)
  ) {
    validationErrors.push("phase37b_operator_extraction_message_hash_mismatch");
  }

  if (
    phase37B?.real_chatgpt_live_mcp_operator_extraction_message_source
    !== "tool_response.chatgpt_operator_compact_diagnostics_live_mcp_final_emission_contract_smoke.live_mcp_final_emission_contract_message_text"
  ) {
    validationErrors.push("phase37b_operator_extraction_message_source_not_phase37a_reference");
  }

  if (phase37B?.real_chatgpt_live_mcp_operator_extraction_consumer_hard_seal_is_reference_only !== true) {
    validationErrors.push("phase37b_operator_extraction_consumer_hard_seal_reference_only_not_true");
  }

  if (phase37B?.real_chatgpt_live_mcp_operator_extraction_consumer_hard_seal_adds_output_layer !== false) {
    validationErrors.push("phase37b_operator_extraction_consumer_hard_seal_adds_output_layer_not_false");
  }

  if (phase37B?.real_chatgpt_live_mcp_operator_extraction_consumer_hard_seal_requires_no_result_read !== true) {
    validationErrors.push("phase37b_operator_extraction_no_result_read_guard_not_true");
  }

  if (phase37B?.real_chatgpt_live_mcp_operator_extraction_consumer_hard_seal_requires_no_chatgpt_final_output_text_read !== true) {
    validationErrors.push("phase37b_operator_extraction_no_chatgpt_final_output_text_guard_not_true");
  }

  if (phase37B?.real_chatgpt_live_mcp_operator_extraction_consumer_hard_seal_requires_no_phase36l_direct_read !== true) {
    validationErrors.push("phase37b_operator_extraction_no_phase36l_direct_read_guard_not_true");
  }

  if (phase37B?.real_chatgpt_live_mcp_operator_extraction_consumer_hard_seal_requires_no_phase36m_direct_read !== true) {
    validationErrors.push("phase37b_operator_extraction_no_phase36m_direct_read_guard_not_true");
  }

  if (phase37B?.real_chatgpt_live_mcp_operator_extraction_consumer_hard_seal_requires_no_recomposition !== true) {
    validationErrors.push("phase37b_operator_extraction_no_recomposition_guard_not_true");
  }

  if (phase37B?.real_chatgpt_live_mcp_operator_extraction_consumer_hard_seal_requires_no_fallback !== true) {
    validationErrors.push("phase37b_operator_extraction_no_fallback_guard_not_true");
  }

  if (typeof acceptedText !== "string") {
    validationErrors.push("accepted_final_operator_message_text_missing_or_not_string");
  }

  if (
    typeof acceptedText === "string"
    && typeof phase37B?.real_chatgpt_live_mcp_operator_extraction_message_text === "string"
    && acceptedText !== phase37B.real_chatgpt_live_mcp_operator_extraction_message_text
  ) {
    validationErrors.push("accepted_final_operator_message_text_phase37b_mismatch");
  }

  const contractValid = validationErrors.length === 0;
  const blocked = contractValid ? phase37B.blocked === true : true;
  const acceptedOperatorMessageText = contractValid
    ? acceptedText
    : [
      "ChatGPT real ChatGPT final operator message consumer contract acceptance invalid.",
      "blocked_stage: operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance",
      "operator_action: inspect_phase37b_real_chatgpt_live_mcp_final_emission_operator_extraction_consumer_hard_seal",
    ].join("\n");
  ...
  return {
    ...
    phase: "37C",
    surface_kind:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceKind,
    version:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceVersion,
    contract_valid: contractValid,
    validation_errors: validationErrors,
    status: contractValid
      ? blocked
        ? "operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance_blocked"
        : "operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance_clear"
      : "operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance_invalid",
    response_kind: contractValid
      ? "operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance_reference"
      : "operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance_invalid_reference",

    real_chatgpt_final_operator_message_consumer_dependency_chain:
      ["36A", "36B", "36C", "36D", "36E", "36F", "36G", "36H", "36I", "36J", "36K", "36L", "36M", "37A", "37B", "37C"],
    real_chatgpt_final_operator_message_consumer_dependency_chain_complete: contractValid,
    real_chatgpt_final_operator_message_consumer_required_read_field:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceRequiredField,
    real_chatgpt_final_operator_message_consumer_must_read_exact_field: true,
    real_chatgpt_final_operator_message_consumer_acceptance_function:
      "acceptChatgptOperatorCompactDiagnosticsFromRealChatgptFinalOperatorMessageConsumerContractAcceptance(tool_response)",
    real_chatgpt_final_operator_message_consumer_accepted_source:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceRequiredField,

    blocked,
    blocked_reason: contractValid
      ? phase37B.blocked_reason ?? null
      : "operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance_invalid",
    can_emit_operator_message: contractValid,
    can_output_to_chat: false,
    may_output_story_text: false,
    must_not_output_candidate: true,
    must_not_output_candidate_reason: blocked
      ? phase37B?.must_not_output_candidate_reason ?? "required_brain_modules_contract_invalid"
      : "real_chatgpt_final_operator_message_consumer_contract_acceptance_is_reference_only",

    real_chatgpt_final_operator_message_consumer_acceptance_items: acceptanceItems,
    real_chatgpt_final_operator_message_consumer_acceptance_items_complete: contractValid,
    real_chatgpt_final_operator_message_consumer_accepted_message_text: acceptedOperatorMessageText,
    real_chatgpt_final_operator_message_consumer_accepted_message_hash: sha256(acceptedOperatorMessageText),
    real_chatgpt_final_operator_message_consumer_accepted_message_source: contractValid
      ? chatgptOperatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptanceRequiredField
      : "operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance.invalid_notice",
    real_chatgpt_final_operator_message_consumer_accepted_message_matches_phase37b_operator_extraction_consumer_hard_seal: contractValid
      && typeof phase37B?.real_chatgpt_live_mcp_operator_extraction_message_text === "string"
      && acceptedOperatorMessageText === phase37B.real_chatgpt_live_mcp_operator_extraction_message_text,
    real_chatgpt_final_operator_message_consumer_accepted_message_hash_matches_phase37b_operator_extraction_consumer_hard_seal: contractValid
      && typeof phase37B?.real_chatgpt_live_mcp_operator_extraction_message_hash === "string"
      && sha256(acceptedOperatorMessageText) === phase37B.real_chatgpt_live_mcp_operator_extraction_message_hash,
    real_chatgpt_final_operator_message_consumer_accepted_message_is_blocked_notice:
      contractValid && blocked && acceptedOperatorMessageText.includes("BLOCKED:"),
    real_chatgpt_final_operator_message_consumer_accepted_message_is_clear_notice:
      contractValid && !blocked && acceptedOperatorMessageText.includes("READY:"),

    phase37b_operator_extraction_status: phase37B?.status ?? null,
    phase37b_operator_extraction_hash:
      phase37B?.real_chatgpt_live_mcp_operator_extraction_message_hash ?? null,
    phase37b_operator_extraction_source:
      phase37B?.real_chatgpt_live_mcp_operator_extraction_message_source ?? null,

    real_chatgpt_final_operator_message_consumer_contract_acceptance_is_reference_only: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_adds_output_layer: false,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_must_not_replace_final_output: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_must_not_be_emitted_as_story_text: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_must_not_be_used_as_candidate_text: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_phase37b_operator_extraction_consumer_hard_seal: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_result_read: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_chatgpt_final_output_text_read: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_phase36l_direct_read: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_phase36m_direct_read: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_phase37a_direct_read: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_recomposition: true,
    real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_fallback: true,

    must_not_read_result: true,
    must_not_read_chatgpt_final_output_text_for_real_chatgpt_final_operator_message_consumer: true,
    must_not_read_phase36l_final_live_extraction_message_text: true,
    must_not_read_phase36m_final_emission_operator_checklist_message_text: true,
    must_not_read_phase37a_live_mcp_final_emission_contract_message_text: true,
    must_not_read_phase37b_output_text_decoy: true,
    must_not_read_nested_result_candidate_text: true,
    must_not_read_nested_brain_contract: true,
    must_not_recompose_response: true,
    ...
    may_read_tool_response_result: false,
    may_read_chatgpt_final_output_text: false,
    may_read_phase36l_final_live_extraction_message_text: false,
    may_read_phase36m_final_emission_operator_checklist_message_text: false,
    may_read_phase37a_live_mcp_final_emission_contract_message_text: false,
    may_save_candidate: false,
    may_approve_candidate: false,
    may_adopt_candidate: false,
    may_update_canon: false,
...
export const chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealKind =
  "chatgpt_bridge_operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal";

export const chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealVersion =
  "chatgpt_bridge_operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal_v1";

export const chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealRequiredField =
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealRequiredTopLevelKeys() {
  return [
    "tool_name",
    "permission",
    "chatgpt_final_output",
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealForbiddenSources() {
  return [
    "tool_response.result.*",
    "tool_response.result.final_candidate_text",
    "tool_response.result.extracted_chatgpt_final_output.output_text",
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealItems() {
  return [
    {
      id: "must_read_phase37c_accepted_message_text",
      status: "required",
      instruction:
        "Read the final response emission message only from Phase37C accepted message text.",
      required_read_field:
        chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealRequiredField,
      required_value: true,
    },
    {
      id: "must_not_read_result_or_chatgpt_final_output",
    ...
    {
      id: "must_not_directly_read_lower_operator_message_fields",
      status: "required",
      instruction:
        "Do not directly read Phase36L, Phase36M, Phase37A, or Phase37B message fields from the final response emission path.",
      required_value: true,
    },
    {
      id: "must_ignore_output_text_and_operator_display_decoys",
      status: "required",
      instruction:
        "Ignore output_text/operator_display_text decoys on all diagnostics surfaces.",
      required_value: true,
    },
    {
      id: "must_preserve_final_response_emission_reference_only",
      status: "required",
      instruction:
        "The final response emission seal is reference-only and must not become a story/candidate output layer.",
      required_value: true,
    },
  ];
}

export function acceptChatgptOperatorCompactDiagnosticsFromRealChatgptFinalResponseEmissionConsumerSeal(toolResponse = {}) {
  return toolResponse
    ?.chatgpt_operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance
    ?.real_chatgpt_final_operator_message_consumer_accepted_message_text;
}

export function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSeal(toolResponse = {}) {
  const phase37C =
    toolResponse
      ?.chatgpt_operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance
    ?? null;
  ...
  const phase37CIndex =
    topLevelKeys.indexOf("chatgpt_operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance");
  const phase37DIndex =
    topLevelKeys.indexOf("chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal");
  const requiredTopLevelKeys =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealRequiredTopLevelKeys();
  const forbiddenSources =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealForbiddenSources();
  const sealItems =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealItems();
  const acceptedText =
    acceptChatgptOperatorCompactDiagnosticsFromRealChatgptFinalResponseEmissionConsumerSeal(toolResponse);
  const validationErrors = [];
  ...
  if (phase37CIndex < 0) {
    validationErrors.push("top_level_phase37c_final_operator_message_consumer_contract_acceptance_missing");
  }

  if (phase37CIndex >= 0 && phase37DIndex >= 0 && phase37CIndex > phase37DIndex) {
    validationErrors.push("phase37c_final_operator_message_consumer_contract_acceptance_should_precede_phase37d_final_response_emission_consumer_seal");
  }

  if (resultIndex >= 0 && phase37DIndex >= 0 && phase37DIndex > resultIndex) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_should_precede_result");
  }

  if (phase37C?.used !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_contract_acceptance_used_false_or_missing");
  }

  if (phase37C?.phase !== "37C") {
    validationErrors.push("phase37c_final_operator_message_consumer_contract_acceptance_phase_not_37c");
  }

  if (phase37C?.contract_valid !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_contract_acceptance_invalid");
  }

  if (
    phase37C?.real_chatgpt_final_operator_message_consumer_required_read_field
    !== "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_live_mcp_final_emission_operator_extraction_consumer_hard_seal.real_chatgpt_live_mcp_operator_extraction_message_text"
  ) {
    validationErrors.push("phase37c_final_operator_message_consumer_required_read_field_mismatch");
  }

  if (phase37C?.real_chatgpt_final_operator_message_consumer_must_read_exact_field !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_exact_field_guard_not_true");
  }

  if (typeof phase37C?.real_chatgpt_final_operator_message_consumer_accepted_message_text !== "string") {
    validationErrors.push("phase37c_final_operator_message_consumer_accepted_message_text_missing_or_not_string");
  }

  if (
    typeof phase37C?.real_chatgpt_final_operator_message_consumer_accepted_message_hash !== "string"
    || phase37C.real_chatgpt_final_operator_message_consumer_accepted_message_hash.length === 0
  ) {
    validationErrors.push("phase37c_final_operator_message_consumer_accepted_message_hash_missing");
  } else if (
    typeof phase37C?.real_chatgpt_final_operator_message_consumer_accepted_message_text === "string"
    && phase37C.real_chatgpt_final_operator_message_consumer_accepted_message_hash
      !== sha256(phase37C.real_chatgpt_final_operator_message_consumer_accepted_message_text)
  ) {
    validationErrors.push("phase37c_final_operator_message_consumer_accepted_message_hash_mismatch");
  }

  if (
    phase37C?.real_chatgpt_final_operator_message_consumer_accepted_message_source
    !== "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_live_mcp_final_emission_operator_extraction_consumer_hard_seal.real_chatgpt_live_mcp_operator_extraction_message_text"
  ) {
    validationErrors.push("phase37c_final_operator_message_consumer_accepted_message_source_not_phase37b_reference");
  }

  if (phase37C?.real_chatgpt_final_operator_message_consumer_contract_acceptance_is_reference_only !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_contract_acceptance_reference_only_not_true");
  }

  if (phase37C?.real_chatgpt_final_operator_message_consumer_contract_acceptance_adds_output_layer !== false) {
    validationErrors.push("phase37c_final_operator_message_consumer_contract_acceptance_adds_output_layer_not_false");
  }

  if (phase37C?.real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_result_read !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_no_result_read_guard_not_true");
  }

  if (phase37C?.real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_chatgpt_final_output_text_read !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_no_chatgpt_final_output_text_guard_not_true");
  }

  if (phase37C?.real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_phase36l_direct_read !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_no_phase36l_direct_read_guard_not_true");
  }

  if (phase37C?.real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_phase36m_direct_read !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_no_phase36m_direct_read_guard_not_true");
  }

  if (phase37C?.real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_phase37a_direct_read !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_no_phase37a_direct_read_guard_not_true");
  }

  if (phase37C?.real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_recomposition !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_no_recomposition_guard_not_true");
  }

  if (phase37C?.real_chatgpt_final_operator_message_consumer_contract_acceptance_requires_no_fallback !== true) {
    validationErrors.push("phase37c_final_operator_message_consumer_no_fallback_guard_not_true");
  }

  if (typeof acceptedText !== "string") {
    validationErrors.push("accepted_final_response_emission_message_text_missing_or_not_string");
  }

  if (
    typeof acceptedText === "string"
    && typeof phase37C?.real_chatgpt_final_operator_message_consumer_accepted_message_text === "string"
    && acceptedText !== phase37C.real_chatgpt_final_operator_message_consumer_accepted_message_text
  ) {
    validationErrors.push("accepted_final_response_emission_message_text_phase37c_mismatch");
  }

  const contractValid = validationErrors.length === 0;
  const blocked = contractValid ? phase37C.blocked === true : true;
  const finalResponseEmissionMessageText = contractValid
    ? acceptedText
    : [
      "ChatGPT real ChatGPT final response emission consumer seal invalid.",
      "blocked_stage: operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal",
      "operator_action: inspect_phase37c_real_chatgpt_final_operator_message_consumer_contract_acceptance",
    ].join("\n");
  ...
  return {
    ...
    phase: "37D",
    surface_kind:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealKind,
    version:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealVersion,
    contract_valid: contractValid,
    validation_errors: validationErrors,
    status: contractValid
      ? blocked
        ? "operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal_blocked"
        : "operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal_clear"
      : "operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal_invalid",
    response_kind: contractValid
      ? "operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal_reference"
      : "operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal_invalid_reference",

    real_chatgpt_final_response_emission_dependency_chain:
      ["36A", "36B", "36C", "36D", "36E", "36F", "36G", "36H", "36I", "36J", "36K", "36L", "36M", "37A", "37B", "37C", "37D"],
    real_chatgpt_final_response_emission_dependency_chain_complete: contractValid,
    real_chatgpt_final_response_emission_required_read_field:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealRequiredField,
    real_chatgpt_final_response_emission_must_read_exact_field: true,
    real_chatgpt_final_response_emission_acceptance_function:
      "acceptChatgptOperatorCompactDiagnosticsFromRealChatgptFinalResponseEmissionConsumerSeal(tool_response)",
    real_chatgpt_final_response_emission_accepted_source:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealRequiredField,

    blocked,
    blocked_reason: contractValid
      ? phase37C.blocked_reason ?? null
      : "operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal_invalid",
    can_emit_operator_message: contractValid,
    can_output_to_chat: false,
    may_output_story_text: false,
    must_not_output_candidate: true,
    must_not_output_candidate_reason: blocked
      ? phase37C?.must_not_output_candidate_reason ?? "required_brain_modules_contract_invalid"
      : "real_chatgpt_final_response_emission_consumer_seal_is_reference_only",

    real_chatgpt_final_response_emission_items: sealItems,
    real_chatgpt_final_response_emission_items_complete: contractValid,
    real_chatgpt_final_response_emission_message_text: finalResponseEmissionMessageText,
    real_chatgpt_final_response_emission_message_hash: sha256(finalResponseEmissionMessageText),
    real_chatgpt_final_response_emission_message_source: contractValid
      ? chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSealRequiredField
      : "operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal.invalid_notice",
    real_chatgpt_final_response_emission_message_matches_phase37c_final_operator_message_consumer_contract_acceptance: contractValid
      && typeof phase37C?.real_chatgpt_final_operator_message_consumer_accepted_message_text === "string"
      && finalResponseEmissionMessageText === phase37C.real_chatgpt_final_operator_message_consumer_accepted_message_text,
    real_chatgpt_final_response_emission_message_hash_matches_phase37c_final_operator_message_consumer_contract_acceptance: contractValid
      && typeof phase37C?.real_chatgpt_final_operator_message_consumer_accepted_message_hash === "string"
      && sha256(finalResponseEmissionMessageText) === phase37C.real_chatgpt_final_operator_message_consumer_accepted_message_hash,
    real_chatgpt_final_response_emission_message_is_blocked_notice:
      contractValid && blocked && finalResponseEmissionMessageText.includes("BLOCKED:"),
    real_chatgpt_final_response_emission_message_is_clear_notice:
      contractValid && !blocked && finalResponseEmissionMessageText.includes("READY:"),

    phase37c_final_operator_message_consumer_status: phase37C?.status ?? null,
    phase37c_final_operator_message_consumer_hash:
      phase37C?.real_chatgpt_final_operator_message_consumer_accepted_message_hash ?? null,
    phase37c_final_operator_message_consumer_source:
      phase37C?.real_chatgpt_final_operator_message_consumer_accepted_message_source ?? null,

    real_chatgpt_final_response_emission_consumer_seal_is_reference_only: true,
    real_chatgpt_final_response_emission_consumer_seal_adds_output_layer: false,
    real_chatgpt_final_response_emission_consumer_seal_must_not_replace_final_output: true,
    real_chatgpt_final_response_emission_consumer_seal_must_not_be_emitted_as_story_text: true,
    real_chatgpt_final_response_emission_consumer_seal_must_not_be_used_as_candidate_text: true,
    real_chatgpt_final_response_emission_consumer_seal_requires_phase37c_final_operator_message_consumer_contract_acceptance: true,
    real_chatgpt_final_response_emission_consumer_seal_requires_no_result_read: true,
    real_chatgpt_final_response_emission_consumer_seal_requires_no_chatgpt_final_output_text_read: true,
    real_chatgpt_final_response_emission_consumer_seal_requires_no_phase36l_direct_read: true,
    real_chatgpt_final_response_emission_consumer_seal_requires_no_phase36m_direct_read: true,
    real_chatgpt_final_response_emission_consumer_seal_requires_no_phase37a_direct_read: true,
    real_chatgpt_final_response_emission_consumer_seal_requires_no_phase37b_direct_read: true,
    real_chatgpt_final_response_emission_consumer_seal_requires_no_recomposition: true,
    real_chatgpt_final_response_emission_consumer_seal_requires_no_fallback: true,

    must_not_read_result: true,
    must_not_read_chatgpt_final_output_text_for_real_chatgpt_final_response_emission: true,
    must_not_read_phase36l_final_live_extraction_message_text: true,
    must_not_read_phase36m_final_emission_operator_checklist_message_text: true,
    must_not_read_phase37a_live_mcp_final_emission_contract_message_text: true,
    must_not_read_phase37b_operator_extraction_message_text: true,
    must_not_read_phase37c_output_text_decoy: true,
    must_not_read_nested_result_candidate_text: true,
    must_not_read_nested_brain_contract: true,
    must_not_recompose_response: true,
    ...
    may_read_phase36m_final_emission_operator_checklist_message_text: false,
    may_read_phase37a_live_mcp_final_emission_contract_message_text: false,
    may_read_phase37b_operator_extraction_message_text: false,
    may_save_candidate: false,
    may_approve_candidate: false,
    may_adopt_candidate: false,
    may_update_canon: false,
...
export const chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexKind =
  "chatgpt_bridge_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index";

export const chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexVersion =
  "chatgpt_bridge_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index_v1";

export const chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexRequiredField =
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexRequiredTopLevelKeys() {
  return [
    "tool_name",
    "permission",
    "chatgpt_final_output",
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexForbiddenSources() {
  return [
    "tool_response.result.*",
    "tool_response.result.final_candidate_text",
    "tool_response.result.extracted_chatgpt_final_output.output_text",
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexItems() {
  return [
    {
      id: "must_close_phase36m_to_phase37e_chain",
      status: "required",
      instruction:
        "Close the Phase36M through Phase37E final response consumer chain as reference-only evidence.",
      required_value: true,
    },
    {
      id: "must_depend_on_phase37d_consumer_seal",
      status: "required",
      instruction:
        "Depend only on the Phase37D final response emission consumer seal hash/source references.",
      required_read_field:
        chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexRequiredField,
      required_value: true,
    },
    {
      id: "must_not_emit_candidate_or_operator_text",
      status: "required",
      instruction:
        "Do not expose output_text, operator_display_text, message_text, story text, or candidate text.",
      required_value: true,
    },
    {
      id: "must_not_read_result_or_chatgpt_final_output",
      status: "required",
      instruction:
        "Do not read result.*, chatgpt_final_output.output_text, diagnostics, debug, checklist, closure index, or evidence packet text as final chat output.",
      required_value: true,
    },
    {
      id: "must_preserve_candidate_only_governance",
      status: "required",
      instruction:
...
export function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndex(toolResponse = {}) {
  const phase37D =
    toolResponse?.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal
    ?? null;
  const topLevelKeys = toolResponse != null && typeof toolResponse === "object"
    ? Object.keys(toolResponse)
    : [];
  ...
  const phase37DIndex =
    topLevelKeys.indexOf("chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal");
  const phase37FIndex =
    topLevelKeys.indexOf("chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index");
  const requiredTopLevelKeys =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexRequiredTopLevelKeys();
  const forbiddenSources =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexForbiddenSources();
  const closureItems =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexItems();
  const validationErrors = [];
  ...
  if (phase37DIndex < 0) {
    validationErrors.push("top_level_phase37d_final_response_emission_consumer_seal_missing");
  }

  if (phase37DIndex >= 0 && phase37FIndex >= 0 && phase37DIndex > phase37FIndex) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_should_precede_phase37f_closure_index");
  }

  if (resultIndex >= 0 && phase37FIndex >= 0 && phase37FIndex > resultIndex) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_should_precede_result");
  }

  if (phase37D?.used !== true) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_used_false_or_missing");
  }

  if (phase37D?.phase !== "37D") {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_phase_not_37d");
  }

  if (phase37D?.contract_valid !== true) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_invalid");
  }

  if (
    phase37D?.real_chatgpt_final_response_emission_required_read_field
    !== "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance.real_chatgpt_final_operator_message_consumer_accepted_message_text"
  ) {
    validationErrors.push("phase37d_final_response_emission_required_read_field_mismatch");
  }

  if (phase37D?.real_chatgpt_final_response_emission_must_read_exact_field !== true) {
    validationErrors.push("phase37d_final_response_emission_exact_field_guard_not_true");
  }

  if (typeof phase37D?.real_chatgpt_final_response_emission_message_hash !== "string"
    || phase37D.real_chatgpt_final_response_emission_message_hash.length === 0) {
    validationErrors.push("phase37d_final_response_emission_message_hash_missing");
  } else if (
    typeof phase37D?.real_chatgpt_final_response_emission_message_text === "string"
    && phase37D.real_chatgpt_final_response_emission_message_hash
      !== sha256(phase37D.real_chatgpt_final_response_emission_message_text)
  ) {
    validationErrors.push("phase37d_final_response_emission_message_hash_mismatch");
  }

  if (
    phase37D?.real_chatgpt_final_response_emission_message_source
    !== "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance.real_chatgpt_final_operator_message_consumer_accepted_message_text"
  ) {
    validationErrors.push("phase37d_final_response_emission_message_source_not_phase37c_reference");
  }

  if (phase37D?.real_chatgpt_final_response_emission_message_matches_phase37c_final_operator_message_consumer_contract_acceptance !== true) {
    validationErrors.push("phase37d_final_response_emission_message_not_matched_to_phase37c");
  }

  if (phase37D?.real_chatgpt_final_response_emission_message_hash_matches_phase37c_final_operator_message_consumer_contract_acceptance !== true) {
    validationErrors.push("phase37d_final_response_emission_hash_not_matched_to_phase37c");
  }

  if (phase37D?.real_chatgpt_final_response_emission_consumer_seal_is_reference_only !== true) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_reference_only_not_true");
  }

  if (phase37D?.real_chatgpt_final_response_emission_consumer_seal_adds_output_layer !== false) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_adds_output_layer_not_false");
  }

  if (phase37D?.real_chatgpt_final_response_emission_consumer_seal_must_not_replace_final_output !== true) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_replace_guard_not_true");
  }

  if (phase37D?.real_chatgpt_final_response_emission_consumer_seal_requires_no_result_read !== true) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_no_result_read_guard_not_true");
  }

  if (phase37D?.real_chatgpt_final_response_emission_consumer_seal_requires_no_chatgpt_final_output_text_read !== true) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_no_chatgpt_final_output_text_guard_not_true");
  }

  if (phase37D?.real_chatgpt_final_response_emission_consumer_seal_requires_no_recomposition !== true) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_no_recomposition_guard_not_true");
  }

  if (phase37D?.real_chatgpt_final_response_emission_consumer_seal_requires_no_fallback !== true) {
    validationErrors.push("phase37d_final_response_emission_consumer_seal_no_fallback_guard_not_true");
  }

  if (phase37D?.can_output_to_chat !== false) {
    validationErrors.push("phase37d_final_response_emission_can_output_to_chat_not_false");
  }

  if (phase37D?.may_output_story_text !== false) {
    validationErrors.push("phase37d_final_response_emission_may_output_story_text_not_false");
  }

  if (phase37D?.must_not_output_candidate !== true) {
    validationErrors.push("phase37d_final_response_emission_must_not_output_candidate_not_true");
  }

  if (phase37D?.may_update_canon !== false) {
    validationErrors.push("phase37d_final_response_emission_may_update_canon_not_false");
  }

  if (phase37D?.may_update_active_engine !== false) {
    validationErrors.push("phase37d_final_response_emission_may_update_active_engine_not_false");
  }

  if (Object.hasOwn(phase37D ?? {}, "output_text")) {
    validationErrors.push("phase37d_final_response_emission_exposes_output_text");
  }

  if (Object.hasOwn(phase37D ?? {}, "operator_display_text")) {
    validationErrors.push("phase37d_final_response_emission_exposes_operator_display_text");
  }

  const contractValid = validationErrors.length === 0;
  const blocked = contractValid ? phase37D.blocked === true : true;

  return {
    used: true,
    phase: "37F",
    surface_kind:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexKind,
    version:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexVersion,
    contract_valid: contractValid,
    validation_errors: validationErrors,
    status: contractValid
      ? blocked
        ? "operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index_blocked"
        : "operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index_clear"
      : "operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index_invalid",
    response_kind: contractValid
      ? "operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index_reference"
      : "operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index_invalid_reference",

    real_chatgpt_final_response_consumer_closure_dependency_chain:
      ["36A", "36B", "36C", "36D", "36E", "36F", "36G", "36H", "36I", "36J", "36K", "36L", "36M", "37A", "37B", "37C", "37D", "37E", "37F"],
    real_chatgpt_final_response_consumer_closure_dependency_chain_complete: contractValid,
    real_chatgpt_final_response_consumer_closure_required_read_field:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndexRequiredField,
    real_chatgpt_final_response_consumer_closure_must_read_exact_field: true,

    blocked,
    blocked_reason: contractValid
      ? phase37D.blocked_reason ?? null
      : "operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index_invalid",
    can_emit_operator_message: false,
    can_output_to_chat: false,
    may_output_story_text: false,
    must_not_output_candidate: true,
    must_not_output_candidate_reason: blocked
      ? phase37D?.must_not_output_candidate_reason ?? "required_brain_modules_contract_invalid"
      : "real_chatgpt_final_response_consumer_closure_index_is_reference_only",

    real_chatgpt_final_response_consumer_closure_items: closureItems,
    real_chatgpt_final_response_consumer_closure_items_complete: contractValid,
    real_chatgpt_final_response_consumer_closure_hash_reference: contractValid
      ? phase37D.real_chatgpt_final_response_emission_message_hash
      : null,
    real_chatgpt_final_response_consumer_closure_source_reference: contractValid
      ? phase37D.real_chatgpt_final_response_emission_message_source
      : null,
    real_chatgpt_final_response_consumer_closure_status_reference: contractValid
      ? phase37D.status
      : null,
    real_chatgpt_final_response_consumer_closure_phase37d_reference_only: contractValid
      && phase37D.real_chatgpt_final_response_emission_consumer_seal_is_reference_only === true,
    real_chatgpt_final_response_consumer_closure_phase37d_message_is_blocked_notice:
      contractValid && phase37D.real_chatgpt_final_response_emission_message_is_blocked_notice === true,
    real_chatgpt_final_response_consumer_closure_phase37d_message_is_clear_notice:
      contractValid && phase37D.real_chatgpt_final_response_emission_message_is_clear_notice === true,

    phase37d_final_response_emission_status: phase37D?.status ?? null,
    phase37d_final_response_emission_hash:
      phase37D?.real_chatgpt_final_response_emission_message_hash ?? null,
    phase37d_final_response_emission_source:
      phase37D?.real_chatgpt_final_response_emission_message_source ?? null,

    real_chatgpt_final_response_consumer_closure_index_is_reference_only: true,
    real_chatgpt_final_response_consumer_closure_index_adds_output_layer: false,
    real_chatgpt_final_response_consumer_closure_index_must_not_replace_final_output: true,
    real_chatgpt_final_response_consumer_closure_index_must_not_be_emitted_as_story_text: true,
    real_chatgpt_final_response_consumer_closure_index_must_not_be_used_as_candidate_text: true,
    real_chatgpt_final_response_consumer_closure_index_requires_phase37d_final_response_emission_consumer_seal: true,
    real_chatgpt_final_response_consumer_closure_index_requires_no_result_read: true,
    real_chatgpt_final_response_consumer_closure_index_requires_no_chatgpt_final_output_text_read: true,
    real_chatgpt_final_response_consumer_closure_index_requires_no_lower_diagnostic_text_read: true,
    real_chatgpt_final_response_consumer_closure_index_requires_no_operator_checklist_text_read: true,
    real_chatgpt_final_response_consumer_closure_index_requires_no_closure_index_text_read: true,
    real_chatgpt_final_response_consumer_closure_index_requires_no_evidence_packet_text_read: true,
    real_chatgpt_final_response_consumer_closure_index_requires_no_recomposition: true,
    real_chatgpt_final_response_consumer_closure_index_requires_no_fallback: true,

    must_not_read_result: true,
    must_not_read_chatgpt_final_output_text_for_real_chatgpt_final_response_consumer_closure: true,
    must_not_read_lower_diagnostic_text_for_real_chatgpt_final_response_consumer_closure: true,
...
export const chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketKind =
  "chatgpt_bridge_operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet";

export const chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketVersion =
  "chatgpt_bridge_operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet_v1";

export const chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketRequiredField =
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketRequiredTopLevelKeys() {
  return [
    "tool_name",
    "permission",
    "chatgpt_final_output",
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketAllowedReadFields() {
  return [
    "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index.contract_valid",
    "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index.blocked",
    "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index.blocked_reason",
    ...
    "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index.real_chatgpt_final_response_consumer_closure_status_reference",
    "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index.real_chatgpt_final_response_consumer_closure_phase37d_reference_only",
    "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index.real_chatgpt_final_response_consumer_closure_phase37d_message_is_blocked_notice",
    "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index.real_chatgpt_final_response_consumer_closure_phase37d_message_is_clear_notice",
  ];
}

function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketForbiddenReadFields() {
  return [
    "tool_response.result.*",
    "tool_response.result.final_candidate_text",
...
function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketItems() {
  return [
    {
      id: "handoff_dependency_is_phase37f_closure_index",
      status: "required",
      instruction:
        "Use the Phase37F final response consumer closure index as the only handoff dependency.",
      required_read_field:
        chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketRequiredField,
      required_value: true,
    },
    {
      id: "handoff_allowed_fields_are_reference_only",
      status: "required",
      instruction:
        "Expose only hash/source/status/blocked/reference fields for operator handoff.",
      required_value: true,
    },
    {
      id: "handoff_forbids_text_surfaces",
      status: "required",
      instruction:
        "Never expose output_text, operator_display_text, message_text, story text, candidate text, diagnostics text, checklist text, closure index text, or evidence packet text.",
      required_value: true,
    },
    {
      id: "handoff_preserves_final_output_lock",
      status: "required",
      instruction:
        "Preserve the final output lock; this packet must not replace or construct the final chat output.",
      required_value: true,
    },
    {
      id: "handoff_preserves_canon_and_active_engine_lock",
      status: "required",
      instruction:
        "Preserve candidate-only governance; Canon and active_engine updates remain forbidden.",
      required_value: true,
...
export function buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacket(toolResponse = {}) {
  const phase37F =
    toolResponse?.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index
    ?? null;
  const topLevelKeys = toolResponse != null && typeof toolResponse === "object"
    ? Object.keys(toolResponse)
    : [];
  ...
  const requiredTopLevelKeys =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketRequiredTopLevelKeys();
  const allowedReadFields =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketAllowedReadFields();
  const forbiddenReadFields =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketForbiddenReadFields();
  const handoffItems =
    buildChatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketItems();
  const validationErrors = [];
  ...
  if (phase37FIndex < 0) {
    validationErrors.push("top_level_phase37f_final_response_consumer_closure_index_missing");
  }

  if (phase37FIndex >= 0 && phase37GIndex >= 0 && phase37FIndex > phase37GIndex) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_should_precede_phase37g_handoff_packet");
  }

  if (resultIndex >= 0 && phase37GIndex >= 0 && phase37GIndex > resultIndex) {
    validationErrors.push("phase37g_final_response_consumer_handoff_packet_should_precede_result");
  }

  if (phase37F?.used !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_used_false_or_missing");
  }

  if (phase37F?.phase !== "37F") {
    validationErrors.push("phase37f_final_response_consumer_closure_index_phase_not_37f");
  }

  if (phase37F?.contract_valid !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_invalid");
  }

  if (
    phase37F?.real_chatgpt_final_response_consumer_closure_required_read_field
    !== "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal.real_chatgpt_final_response_emission_message_hash"
  ) {
    validationErrors.push("phase37f_final_response_consumer_closure_required_read_field_mismatch");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_must_read_exact_field !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_exact_field_guard_not_true");
  }

  if (
    typeof phase37F?.real_chatgpt_final_response_consumer_closure_hash_reference !== "string"
    || phase37F.real_chatgpt_final_response_consumer_closure_hash_reference.length === 0
  ) {
    validationErrors.push("phase37f_final_response_consumer_closure_hash_reference_missing");
  }

  if (
    phase37F?.real_chatgpt_final_response_consumer_closure_source_reference
    !== "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance.real_chatgpt_final_operator_message_consumer_accepted_message_text"
  ) {
    validationErrors.push("phase37f_final_response_consumer_closure_source_reference_not_phase37c_reference");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_phase37d_reference_only !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_phase37d_reference_only_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_is_reference_only !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_reference_only_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_adds_output_layer !== false) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_adds_output_layer_not_false");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_must_not_replace_final_output !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_replace_guard_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_requires_phase37d_final_response_emission_consumer_seal !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_phase37d_guard_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_requires_no_result_read !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_no_result_read_guard_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_requires_no_chatgpt_final_output_text_read !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_no_chatgpt_final_output_text_guard_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_requires_no_lower_diagnostic_text_read !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_no_lower_diagnostic_text_guard_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_requires_no_operator_checklist_text_read !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_no_operator_checklist_text_guard_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_requires_no_closure_index_text_read !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_no_closure_index_text_guard_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_requires_no_evidence_packet_text_read !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_no_evidence_packet_text_guard_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_requires_no_recomposition !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_no_recomposition_guard_not_true");
  }

  if (phase37F?.real_chatgpt_final_response_consumer_closure_index_requires_no_fallback !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_index_no_fallback_guard_not_true");
  }

  if (phase37F?.can_output_to_chat !== false) {
    validationErrors.push("phase37f_final_response_consumer_closure_can_output_to_chat_not_false");
  }

  if (phase37F?.may_output_story_text !== false) {
    validationErrors.push("phase37f_final_response_consumer_closure_may_output_story_text_not_false");
  }

  if (phase37F?.must_not_output_candidate !== true) {
    validationErrors.push("phase37f_final_response_consumer_closure_must_not_output_candidate_not_true");
  }

  if (phase37F?.may_update_canon !== false) {
    validationErrors.push("phase37f_final_response_consumer_closure_may_update_canon_not_false");
  }

  if (phase37F?.may_update_active_engine !== false) {
    validationErrors.push("phase37f_final_response_consumer_closure_may_update_active_engine_not_false");
  }

  if (Object.hasOwn(phase37F ?? {}, "output_text")) {
    validationErrors.push("phase37f_final_response_consumer_closure_exposes_output_text");
  }

  if (Object.hasOwn(phase37F ?? {}, "operator_display_text")) {
    validationErrors.push("phase37f_final_response_consumer_closure_exposes_operator_display_text");
  }

  if (Object.hasOwn(phase37F ?? {}, "message_text")) {
    validationErrors.push("phase37f_final_response_consumer_closure_exposes_message_text");
  }

  if (Object.hasOwn(phase37F ?? {}, "real_chatgpt_final_response_consumer_closure_message_text")) {
    validationErrors.push("phase37f_final_response_consumer_closure_exposes_closure_message_text");
  }

  const contractValid = validationErrors.length === 0;
  const blocked = contractValid ? phase37F.blocked === true : true;

  return {
    used: true,
    phase: "37G",
    surface_kind:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketKind,
    version:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketVersion,
    contract_valid: contractValid,
    validation_errors: validationErrors,
    status: contractValid
      ? blocked
        ? "operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet_blocked"
        : "operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet_clear"
      : "operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet_invalid",
    response_kind: contractValid
      ? "operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet_reference"
      : "operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet_invalid_reference",

    real_chatgpt_final_response_consumer_handoff_dependency_phase: "37F",
    real_chatgpt_final_response_consumer_handoff_dependency_kind:
      "chatgpt_bridge_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index",
    real_chatgpt_final_response_consumer_handoff_required_read_field:
      chatgptOperatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacketRequiredField,
    real_chatgpt_final_response_consumer_handoff_must_read_exact_field: true,
    real_chatgpt_final_response_consumer_handoff_allowed_read_fields: allowedReadFields,
    real_chatgpt_final_response_consumer_handoff_forbidden_read_fields: forbiddenReadFields,
    real_chatgpt_final_response_consumer_handoff_items: handoffItems,
    real_chatgpt_final_response_consumer_handoff_items_complete: contractValid,

    blocked,
    blocked_reason: contractValid
      ? phase37F.blocked_reason ?? null
      : "operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet_invalid",
    can_emit_operator_message: false,
    can_output_to_chat: false,
    may_output_story_text: false,
    must_not_output_candidate: true,
    must_not_output_candidate_reason: blocked
      ? phase37F?.must_not_output_candidate_reason ?? "required_brain_modules_contract_invalid"
      : "real_chatgpt_final_response_consumer_handoff_packet_is_reference_only",

    real_chatgpt_final_response_consumer_handoff_hash_reference: contractValid
      ? phase37F.real_chatgpt_final_response_consumer_closure_hash_reference
      : null,
    real_chatgpt_final_response_consumer_handoff_source_reference: contractValid
      ? phase37F.real_chatgpt_final_response_consumer_closure_source_reference
      : null,
    real_chatgpt_final_response_consumer_handoff_status_reference: contractValid
      ? phase37F.status
      : null,
    real_chatgpt_final_response_consumer_handoff_blocked_reference: contractValid
      ? phase37F.blocked === true
      : true,
    real_chatgpt_final_response_consumer_handoff_blocked_reason_reference: contractValid
      ? phase37F.blocked_reason ?? null
      : "operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet_invalid",

    phase37f_final_response_consumer_closure_status: phase37F?.status ?? null,
    phase37f_final_response_consumer_closure_hash:
      phase37F?.real_chatgpt_final_response_consumer_closure_hash_reference ?? null,
    phase37f_final_response_consumer_closure_source:
      phase37F?.real_chatgpt_final_response_consumer_closure_source_reference ?? null,

    real_chatgpt_final_response_consumer_handoff_packet_is_reference_only: true,
    real_chatgpt_final_response_consumer_handoff_packet_adds_output_layer: false,
    real_chatgpt_final_response_consumer_handoff_packet_must_not_replace_final_output: true,
    real_chatgpt_final_response_consumer_handoff_packet_must_not_be_emitted_as_story_text: true,
    real_chatgpt_final_response_consumer_handoff_packet_must_not_be_used_as_candidate_text: true,
    real_chatgpt_final_response_consumer_handoff_packet_requires_phase37f_closure_index: true,
    real_chatgpt_final_response_consumer_handoff_packet_requires_no_result_read: true,
    real_chatgpt_final_response_consumer_handoff_packet_requires_no_chatgpt_final_output_text_read: true,
    real_chatgpt_final_response_consumer_handoff_packet_requires_no_lower_diagnostic_text_read: true,
    real_chatgpt_final_response_consumer_handoff_packet_requires_no_operator_checklist_text_read: true,
    real_chatgpt_final_response_consumer_handoff_packet_requires_no_closure_index_text_read: true,
    real_chatgpt_final_response_consumer_handoff_packet_requires_no_handoff_packet_text_read: true,
    real_chatgpt_final_response_consumer_handoff_packet_requires_no_evidence_packet_text_read: true,
    real_chatgpt_final_response_consumer_handoff_packet_requires_no_recomposition: true,
    real_chatgpt_final_response_consumer_handoff_packet_requires_no_fallback: true,

    must_not_read_result: true,
    must_not_read_chatgpt_final_output_text_for_real_chatgpt_final_response_consumer_handoff: true,
    must_not_read_lower_diagnostic_text_for_real_chatgpt_final_response_consumer_handoff: true,
    must_not_read_phase37d_message_text_as_output: true,
...
function response(toolName, permission, result, created = []) {
  ...
  let operatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptance;
  try {
    ...
    operatorCompactDiagnosticsRealChatgptFinalOperatorMessageConsumerContractAcceptance = {
      ...
      contract_valid: false,
      validation_errors: [
        "real_chatgpt_final_operator_message_consumer_contract_acceptance_builder_threw",
        String(error?.message ?? error),
      ],
      status: "operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance_invalid",
      response_kind:
        "operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance_invalid_reference",
      real_chatgpt_final_operator_message_consumer_required_read_field:
        "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_live_mcp_final_emission_operator_extraction_consumer_hard_seal.real_chatgpt_live_mcp_operator_extraction_message_text",
      blocked: true,
      blocked_reason: "real_chatgpt_final_operator_message_consumer_contract_acceptance_builder_threw",
      can_emit_operator_message: false,
      can_output_to_chat: false,
      may_output_story_text: false,
      must_not_output_candidate: true,
      real_chatgpt_final_operator_message_consumer_accepted_message_text: invalidText,
      real_chatgpt_final_operator_message_consumer_accepted_message_hash: sha256(invalidText),
      real_chatgpt_final_operator_message_consumer_accepted_message_source:
        "operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance.invalid_notice",
      real_chatgpt_final_operator_message_consumer_contract_acceptance_is_reference_only: true,
      real_chatgpt_final_operator_message_consumer_contract_acceptance_adds_output_layer: false,
      real_chatgpt_final_operator_message_consumer_contract_acceptance_must_not_replace_final_output: true,
  ...
  let operatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSeal;
  try {
    ...
    operatorCompactDiagnosticsRealChatgptFinalResponseEmissionConsumerSeal = {
      ...
      contract_valid: false,
      validation_errors: [
        "real_chatgpt_final_response_emission_consumer_seal_builder_threw",
        String(error?.message ?? error),
      ],
      status: "operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal_invalid",
      response_kind:
        "operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal_invalid_reference",
      real_chatgpt_final_response_emission_required_read_field:
        "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_operator_message_consumer_contract_acceptance.real_chatgpt_final_operator_message_consumer_accepted_message_text",
      blocked: true,
      blocked_reason: "real_chatgpt_final_response_emission_consumer_seal_builder_threw",
      can_emit_operator_message: false,
      can_output_to_chat: false,
      may_output_story_text: false,
      must_not_output_candidate: true,
      real_chatgpt_final_response_emission_message_text: invalidText,
      real_chatgpt_final_response_emission_message_hash: sha256(invalidText),
      real_chatgpt_final_response_emission_message_source:
        "operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal.invalid_notice",
      real_chatgpt_final_response_emission_consumer_seal_is_reference_only: true,
      real_chatgpt_final_response_emission_consumer_seal_adds_output_layer: false,
      real_chatgpt_final_response_emission_consumer_seal_must_not_replace_final_output: true,
  ...
  let operatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndex;
  try {
    ...
    operatorCompactDiagnosticsRealChatgptFinalResponseConsumerClosureIndex = {
      ...
      contract_valid: false,
      validation_errors: [
        "real_chatgpt_final_response_consumer_closure_index_builder_threw",
        String(error?.message ?? error),
      ],
      status: "operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index_invalid",
      response_kind:
        "operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index_invalid_reference",
      real_chatgpt_final_response_consumer_closure_required_read_field:
        "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_emission_consumer_seal.real_chatgpt_final_response_emission_message_hash",
      blocked: true,
      blocked_reason: "real_chatgpt_final_response_consumer_closure_index_builder_threw",
      can_emit_operator_message: false,
      can_output_to_chat: false,
      may_output_story_text: false,
      must_not_output_candidate: true,
  ...
  let operatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacket;
  try {
    ...
    operatorCompactDiagnosticsRealChatgptFinalResponseConsumerHandoffPacket = {
      ...
      contract_valid: false,
      validation_errors: [
        "real_chatgpt_final_response_consumer_handoff_packet_builder_threw",
        String(error?.message ?? error),
      ],
      status: "operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet_invalid",
      response_kind:
        "operator_compact_diagnostics_real_chatgpt_final_response_consumer_handoff_packet_invalid_reference",
      real_chatgpt_final_response_consumer_handoff_required_read_field:
        "tool_response.chatgpt_operator_compact_diagnostics_real_chatgpt_final_response_consumer_closure_index.real_chatgpt_final_response_consumer_closure_hash_reference",
      blocked: true,
      blocked_reason: "real_chatgpt_final_response_consumer_handoff_packet_builder_threw",
      can_emit_operator_message: false,
      can_output_to_chat: false,
      may_output_story_text: false,
      must_not_output_candidate: true,
