...
const enumConstraintFixtures = [
  {
    ...
    expectedMessage: "suite must be one of: mcp, mcp_core, mcp_infrastructure, mcp_reliability, mcp_tunnel, affected, communication, world_simulation, cognition, memory_retrieval, all.",
  },
  {
...
const requiredConstraintFixtures = [
  ...
  ...[
    ...
    ["get_foreshadowing_settlement_surface", "id", {}],
