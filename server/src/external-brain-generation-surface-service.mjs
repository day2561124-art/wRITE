...
function compactCharacterHardFacts(value) {
  ...
  return value.slice(0, 12).map((fact) => compactObject({
    ...
    personality_facts: fact?.personality_facts,
    teaching_principles: fact?.teaching_principles,
    combat_style: fact?.combat_style,
    usage_constraints: fact?.usage_constraints,
