...
function snapshotJournalTelemetry(snapshot) {
  ...
  return {
    ...
    snapshot_fingerprint_cache_source: ["none", "memory", "persistent"].includes(diagnostics.fingerprint_cache_source) ? diagnostics.fingerprint_cache_source : "none",
    snapshot_fingerprint_cache_persistent_loaded: diagnostics.fingerprint_cache_persistent_loaded === true,
    ...
    snapshot_fingerprint_cache_racy_miss_count: Number.isFinite(diagnostics.fingerprint_cache_racy_miss_count) ? diagnostics.fingerprint_cache_racy_miss_count : null,
    ...
    snapshot_fingerprint_cache_persistent_published: diagnostics.fingerprint_cache_persistent_published === true,
    snapshot_authority_available: diagnostics.authority_available === true,
    snapshot_authority_query_attempted: diagnostics.authority_query_attempted === true,
    snapshot_authority_reused: diagnostics.authority_reused === true,
    snapshot_authority_source: diagnostics.authority_source === "mcp_http_parent" ? "mcp_http_parent" : "none",
    snapshot_authority_miss_reason: typeof diagnostics.authority_miss_reason === "string" ? diagnostics.authority_miss_reason : null,
    snapshot_authority_watch_state: ["starting", "synchronizing", "healthy", "unknown", "failed", "unhealthy"].includes(diagnostics.authority_watch_state) ? diagnostics.authority_watch_state : "unknown",
    snapshot_authority_epoch: Number.isFinite(diagnostics.authority_epoch) ? diagnostics.authority_epoch : null,
    snapshot_authority_workspace_epoch: Number.isFinite(diagnostics.authority_workspace_epoch) ? diagnostics.authority_workspace_epoch : null,
    snapshot_authority_query_ms: Number.isFinite(diagnostics.authority_query_ms) ? diagnostics.authority_query_ms : null,
    snapshot_authority_sync_attempted: diagnostics.authority_sync_attempted === true,
    snapshot_authority_sync_started: diagnostics.authority_sync_started === true,
    snapshot_authority_sync_completed: diagnostics.authority_sync_completed === true,
    snapshot_authority_sync_reason: typeof diagnostics.authority_sync_reason === "string" ? diagnostics.authority_sync_reason : null,
    snapshot_authority_sync_change_epoch: Number.isFinite(diagnostics.authority_sync_change_epoch) ? diagnostics.authority_sync_change_epoch : null,
    snapshot_authority_published: diagnostics.authority_published === true,
    snapshot_authority_publish_ms: Number.isFinite(diagnostics.authority_publish_ms) ? diagnostics.authority_publish_ms : null,
