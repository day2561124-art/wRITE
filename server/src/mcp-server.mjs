...
const toolDefinitions = [
  ...
  },
  {
    ...
    description: "Create one persistent server-owned development workstream. Phase 2A captures the current local HEAD as immutable base_head, generates an opaque workstream ID, persists bounded metadata under the shared workspace, and rejects isolated mode until Phase 2B.",
    risk: "low-risk-write",
    annotations: { readOnlyHint: false },
    inputSchema: baseSchema({
      label: {
